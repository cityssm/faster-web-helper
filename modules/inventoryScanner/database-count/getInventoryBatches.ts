...
interface GetInventoryBatchesFilters {
  whereClause?: string
}

function _getInventoryBatches(
  filters: GetInventoryBatchesFilters
): InventoryBatch[] {
...
export function getAvailableInventoryBatches(): InventoryBatch[] {
