...
import getItemValidationJsonData from '../../database/getItemValidationJsonData.js';
export default function handler(request, response) {
    const jsonData = getItemValidationJsonData(request.body.itemStoreroom, request.body.itemNumber);
