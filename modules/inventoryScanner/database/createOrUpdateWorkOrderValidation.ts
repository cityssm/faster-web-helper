...
import type { WorkOrderValidationRecord } from '../types.js'

import getWorkOrderValidation from './getWorkOrderValidation.js'
import { databasePath } from './helpers.database.js'

export default function createOrUpdateWorkOrderValidation(
  validationRecord: WorkOrderValidationRecord,
  timeMillis: number
): void {
  ...
  if (databaseRecord === undefined) {
    database
      .prepare(
        `insert into WorkOrderValidationRecords (
